...
import { getContainerPackingBoard } from '@/app/dashboard/(trip-viewer)/[tripId]/containers/_packing/_data/fetchers';
...
export const GET = authedRoute({
	...
	handler: async ({ user, params }) => {
		...
		const data = await getContainerPackingBoard(params.tripId);
